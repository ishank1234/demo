...
def search(request):
    ...
    elif(a=='bra' or a=='Bra' or a=='BRA' or a=='girls bra'):
        w=Collection.objects.get(p_name='bra')
    elif(a=='panty' or a=='panties' or a=='Panty' or a=='PANTY' or a=='Panties' or a=='girls panty'):
        w=Collection.objects.get(p_name='panty')
    elif(a=='condoms' or a=='condom' or a=='Condom' or a=='Condoms' or a=='CONDOM' ):
        w=Collection.objects.get(p_name='condom')
